...
@Component({
  selector: 'Score-Spider-Component',
  templateUrl: './score.spidergraph.component.html',
  styleUrls: ['./score.spidergraph.component.scss']
})
...
export class ScoreSpidergraphComponent implements OnInit {
  ...
  updateChart(scores: Array<Score>){
    ...
    this.RadarChart(this.id, data, this.ChartOptions);
  }
